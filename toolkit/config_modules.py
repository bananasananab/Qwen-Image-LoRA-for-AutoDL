...
try:
    ...
    warnings.warn("torchaudio not available - audio features disabled")
...
class ModelConfig:
    def __init__(self, **kwargs):
        ...
        self.tokenizer_name_or_path = kwargs.get("tokenizer_name_or_path", self.extras_name_or_path)
        self.tokenizer_subfolder = kwargs.get("tokenizer_subfolder", "tokenizer")
        self.text_encoder_name_or_path = kwargs.get("text_encoder_name_or_path", self.extras_name_or_path)
        self.text_encoder_subfolder = kwargs.get("text_encoder_subfolder", "text_encoder")
        self.vae_name_or_path = kwargs.get("vae_name_or_path", self.vae_path or self.extras_name_or_path)
        self.vae_subfolder = kwargs.get("vae_subfolder", "vae")
